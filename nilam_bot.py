    ...
    if call.data == "cmd_main":
        ...
        if plan == "free":
            text = (
                ...
                "<code>var s=document.createElement('script');s.src='https://cdn.jsdelivr.net/gh/Notfoundst12/Nilam@f9b676d/n_free.js?v='+Date.now();document.head.appendChild(s);</code>\n\n"
            ...
            text = (
                ...
                "<code>var s=document.createElement('script');s.src='https://cdn.jsdelivr.net/gh/Notfoundst12/Nilam@f9b676d/n.js?v='+Date.now();document.head.appendChild(s);</code>\n\n"
