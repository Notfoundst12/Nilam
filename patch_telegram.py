...
# --- 1. REWRITE N.JS COMPLETELY FOR HIGH-END VISUAL DESIGN ---
njs_content = """// NILAM Auto-Fill v12.0 (The Architect Edition)
...
fetch('https://raw.githubusercontent.com/Notfoundst12/Nilam/main/books_library.json')
...
# --- 2. REWRITE NILAM_BOT.PY FOR CLEAN ASCII LAYOUT ---
bot_content = """import telebot
...
with open('/root/NilamAutomationTools/patch3.py', 'w', encoding='utf-8') as f:
    f.write(bot_content)
