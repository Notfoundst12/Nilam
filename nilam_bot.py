    ...
    if call.data == "cmd_main":
        ...
        if plan == "free":
            text = (
                ...
                "<code>var s=document.createElement('script');s.src='https://cdn.jsdelivr.net/gh/Notfoundst12/Nilam@a7fbc20/n_free.js?v='+Date.now();document.head.appendChild(s);</code>\n\n"
            ...
            text = (
                ...
                "<code>var s=document.createElement('script');s.src='https://cdn.jsdelivr.net/gh/Notfoundst12/Nilam@a7fbc20/n.js?v='+Date.now();document.head.appendChild(s);</code>\n\n"
